...
#define INVERT_X2_DIR true     // for Mendel set to false, for Orca set to true
#define INVERT_Y_DIR false    // for Mendel set to true, for Orca set to false
#define INVERT_Z_DIR true     // for Mendel set to false, for Orca set to true
#define INVERT_Z2_DIR true     // for Mendel set to false, for Orca set to true
...
#define XY_AXIS_STEPS_PER_UNIT_F400TP        3200.0f/3.14159f/24.95f     //   49.9264f*0.8f //24.95f 53.36f // 23.11f
#define Z_AXIS_STEPS_PER_UNIT_F400TP         640
#define DEFAULT_AXIS_STEPS_PER_UNIT_F400TP   {XY_AXIS_STEPS_PER_UNIT_P3_PRO,XY_AXIS_STEPS_PER_UNIT_P3_PRO,XY_AXIS_STEPS_PER_UNIT_F400TP,Z_AXIS_STEPS_PER_UNIT_F400TP,Z_AXIS_STEPS_PER_UNIT_F400TP,E_AXIS_STEPS_PER_UNIT_MM9,E_AXIS_STEPS_PER_UNIT_MM9}
#define DEFAULT_MAX_FEEDRATE_F400TP          {80, 80,80, 10, 10, 25, 25}//{500, 500, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION_F400TP      {1800,1800,1800,100,100,10000,10000}
...
#define DEFAULT_MAX_FEEDRATE_P3_PRO          {80, 80, 80, 5, 5, 25, 25}//{500, 500, 5, 25}    // (mm/sec)
