...
extern void SaveMatCheckAvgVol(float MatCheckAvgVolValue);
...
// 串口測試（0：関；1：開）
#define DEBUG_MACHINE_CUSTOM 1      // 是否打印配置信息( 1:打开 ,0 :不打开 )
#if (1 == DEBUG_MACHINE_CUSTOM)
#define DEBUG_SYSCONFIG_CUSTOM 0
#define DEBUG_SERVICES_CUSTOM 0
#endif
